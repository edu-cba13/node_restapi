...
describe('## Clinicas Alta Complejidad APIs', () => {

    describe('# GET /api-cartilla/v1/clinicasaltacomplejidad', () => {
        it('should get all clinicas alta complejidad', (done) => {
            request(app)
                .get('/api-cartilla/v1/clinicasaltacomplejidad')
                ...
                .then((res) => {
                    ...
                    expect(res.body.rows[0]).to.have.property('id_especialidad_clinica_alta_complejidad').to.be.a('number');
    ...
    describe('# GET /api-cartilla/v1/clinicasaltacomplejidad?limit=3&offset=2', () => {
        it('should get clinicas alta complejidad with params limit=3 and offset=2', (done) => {
            request(app)
                .get('/api-cartilla/v1/clinicasaltacomplejidad?limit=3&offset=2')
                .set({ 'api_key': mock.api_key })
                .expect(httpStatus.OK)
                .then((res) => {
                    expect(res.body).to.be.an('object');
                    ...
                    expect(res.body.rows[0]).to.have.property('entidad').to.be.a('object');
                    expect(res.body.rows[0]).to.have.property('entidad_hijo');
                    expect(res.body.rows[0]).to.have.property('id').to.be.equal(1152);
    ...
    describe('# GET /api-cartilla/v1/clinicasaltacomplejidad?sort=id desc', () => {
        it('should get clinicas alta complejidad with params sort=id desc', (done) => {
            request(app)
                .get('/api-cartilla/v1/clinicasaltacomplejidad?sort=id desc')
                .set({ 'api_key': mock.api_key })
                .expect(httpStatus.OK)
                .then((res) => {
                    expect(res.body).to.be.an('object');
                    ...
                    expect(res.body.rows[0]).to.have.property('entidad').to.be.a('object');
                    expect(res.body.rows[0]).to.have.property('entidad_hijo');
                    expect(res.body.rows[0]).to.have.property('id').to.be.equal(1150);
                    done();
                })
                .catch(done);
        });
    ...
    describe('# GET /api-cartilla/v1/clinicasaltacomplejidad?filter=id eq eq 1150', () => {
        it('should get clinicas alta complejidad with params filter=id eq 1150', (done) => {
            request(app)
                .get('/api-cartilla/v1/clinicasaltacomplejidad?filter=id eq 1150')
                .set({ 'api_key': mock.api_key })
                .expect(httpStatus.OK)
                .then((res) => {
                    expect(res.body).to.be.an('object');
    ...
    describe('# GET /api-cartilla/v1/clinicasaltacomplejidad/{:id}', () => {
        it('should get clinicas alta complejidad whith id 1150', (done) => {
            request(app)
                .get('/api-cartilla/v1/clinicasaltacomplejidad/1150')
                .set({ 'api_key': mock.api_key })
                .expect(httpStatus.OK)
                .then((res) => {
                    expect(res.body).to.be.an('object');
                    expect(res.body).to.have.property('id').to.be.a('number');
                    expect(res.body).to.have.property('id_especialidad_clinica_alta_complejidad').to.be.a('number');
                    ...
                    expect(res.body).to.have.property('id').to.be.equal(1150);
                    done();
                })
                .catch(done);
        });
    ...
    describe('# GET /api-cartilla/v1/clinicasaltacomplejidad/domicilios', () => {
        it('should get all clinicas alta complejidad and all domicilios', (done) => {
            request(app)
                .get('/api-cartilla/v1/clinicasaltacomplejidad/domicilios')
                .set({ 'api_key': mock.api_key })
                .expect(httpStatus.OK)
                .then((res) => {
                    expect(res.body).to.be.an('object');
